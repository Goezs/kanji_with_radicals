...
kanjies_and_data.to_csv("kanjies_and_data.csv", columns= ["Kanji", "Meaning", "Radicals", "Sound"])

# Generate empty vocabulary dataset
vocabulary = pd.DataFrame(columns= ["Kanji", "Meaning", "Radicals", "Sound"])

vocabulary.to_csv("vocabulary.csv", columns= ["Kanji", "Meaning", "Radicals", "Sound"])